...
TEST_BOSONIC_BASIC = {
    "TEST_CASE": 4,
    "CODE_INSTANCE": [BitFlipCode(), PhaseFlipCode(), SteaneCode(), FiveCode(), ConcCode([PhaseFlipCode(),ParaCode([BitFlipCode(),BitFlipCode(),BitFlipCode()])])]
}
...
def test_bosonic_calc_llr():
    ...
    for i in TEST_BOSONIC_CALC_LLR["PARAM"]:
        assert my_gkp.calc_llr(TEST_BOSONIC_CALC_LLR["PARAM"][0],TEST_BOSONIC_CALC_LLR["PARAM"][1]) == TEST_BOSONIC_CALC_LLR["PARAM"][2]
